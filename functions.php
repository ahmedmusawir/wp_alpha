...
if ( ! function_exists( 'alpha_validate_length' ) ) {
	function alpha_validate_length( $fieldValue, $minLength ) {
		//First, remove trailing and leading whitspace 
...
/*-----  End of 8.0 - Function that validates a field's length.  ------*/
...
/*-----  End of 9.0 - Include the generated CSS in the page header.  ------*/
...
/*-----  End of 10.0 - Load the custom scripts for the theme.  ------*/
